...
//        return cursor;
    ...
    public static UserLogin checkCredentials(String phoneNumber, String password) {
        ...
        try {
            ...
            String query = "select * from UserLogin where  PhoneNumber='" + phoneNumber + "' and Password='" + password + "';";
            Log.e(Constants.LOG_DATABASE, "check credentials: " + query);
            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    if (cursor.moveToFirst()) {
                        ...
                        userLogin.setName(cursor.getString(1));
                        userLogin.setPhoneNumber(cursor.getString(2));
                        userLogin.setPassword(cursor.getString(3));
                        userLogin.setEmail(cursor.getString(4));
                    }
                }
                cursor.close();
            } else {
                Log.e(Constants.LOG_DATABASE, "cursor is null at checkcredential function");
            }
